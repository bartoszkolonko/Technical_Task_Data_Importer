...
namespace CrmEarlyBound
{
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		/// <summary>
		/// The riskiness of signing the contract
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_riskofsigning")]
		public Microsoft.Xrm.Sdk.OptionSetValue new_riskofsigning
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.OptionSetValue>("new_riskofsigning");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("new_riskofsigning");
				this.SetAttributeValue("new_riskofsigning", value);
				this.OnPropertyChanged("new_riskofsigning");
			}
		}
